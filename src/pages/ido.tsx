...
export default function IdoPage() {
  ...
  const { getPoolIdoData, ido_commit, getIdoContribution, ido_claim } =
    useProgram();
...
console.log('poolData :>> ', poolData);
  ...
  return (
    <div className="ido-dashboard">
      <div className="ido-main-panel">
        <div className="ido-main-banner">
          ALL PARTICIPANTS THAT CONTRIBUTE ABOVE 90 $SUI WILL GET 1 FREE
          COSMOCADIA NFT
        </div>
          ...
          <div className="ido-info-panel">
            ...
            <div className="ido-info-panel-content">
              ...
              <div className="ido-info-item">
                ...
                <div className="ido-info-item-value">
                  <a rel="noreferrer" href={InfoIdo.token.link} target="_blank">
                    {InfoIdo.token.contract.substr(0, 4) +
                      "..." +
                      InfoIdo.token.contract.substr(-4, 4)}
                  </a>
                  &nbsp;
                  <Tooltip title="Copy" placement="top" arrow>
                    ...
                    >
                      <CopyIcon
                        sx={{ fontSize: "20px", color: "rgb(118, 139, 173)" }}
                      />
                    </IconButton>
                  </Tooltip>
                </div>
              ...
              <div className="ido-info-item">
                ...
                <div className="ido-info-item-value">
                  <a rel="noreferrer" href={InfoIdo.link} target="_blank">
                    {InfoIdo.pool.substr(0, 4) +
                      "..." +
                      InfoIdo.pool.substr(-4, 4)}
                  </a>
                  &nbsp;
                  <Tooltip title="Copy" placement="top" arrow>
                    <IconButton
              ...
              <div className="ido-info-item">
                ...
                <div className="ido-info-item-value">
                  {poolData != null && poolData.rate !== undefined ? (
                    <>
                      1&nbsp;
                      <img src={SuiLogoIMG} alt="logo" width="20px" />
                      &nbsp;=&nbsp;{poolData.rate / 10 ** 9}&nbsp;
                      <img src={LogoIMG} alt="logo" width="20px" />
                    </>
                  ) : (
              ...
              <div className="ido-info-item">
                ...
                <div className="ido-info-item-value">
                  {poolData != null ? (
                    <>
                      {poolData.max_commit / 10 ** InfoIdo.suiDecimals}&nbsp;
                      <img src={SuiLogoIMG} alt="logo" width="20px" />
                    </>
                  ) : (
                    <Skeleton
              ...
              <div className="ido-info-item">
                ...
                <div className="ido-info-item-value">
                  {poolData != null ? (
                    <>
                      {poolData.min_commit / 10 ** InfoIdo.suiDecimals}&nbsp;
                      <img src={SuiLogoIMG} alt="logo" width="20px" />
                    </>
                  ) : (
                    <Skeleton
              ...
              <div className="ido-info-item">
                ...
                <div className="ido-info-item-value">
                  {InfoIdo.startTime + " ~ " + InfoIdo.endTime}
                </div>
              </div>
              <div className="ido-info-item">
                ...
                <div className="ido-info-item-value">
                  5/17 on&nbsp;
                  <a rel="noreferrer" href="https://cetus.zone" target="_blank">
                    CETUS DEX
                  </a>
                </div>
              </div>
            ...
            {poolData == null ? (
              ...
              <>
                  ...
                  <div className="ido-commit-status">
                    <div className="ido-commit-circle-wrapper">
                      ...
                      <CircularProgress
                        variant="determinate"
                        value={Math.floor(
                          (poolData.amount / poolData.hard_cap) * 100
                        )}
                        size={200}
                        sx={{
                          position: "absolute",
                          color:
                            poolData.amount > poolData.soft_cap
                              ? "#00ff33"
                              : "#ffd044",
                ...
                <div className="ido-current-wallet-status">
                  ...
                  {wallet.connected && (
                    <div
                      className="ido-info-item"
                      style={{ margin: "4px auto" }}
                    >
                      <div className="ido-info-item-name">
                        Your Contribution
                      </div>
                      <div className="ido-info-item-value">
                        {userContribution / 10 ** InfoIdo.suiDecimals}&nbsp;
                        <img src={SuiLogoIMG} alt="logo" width="20px" />
                      </div>
                    </div>
                  )}
                  ...
                  <div className="amount-input-wrapper">
                    <input
                      ...
                      disabled={currentTime > Number(poolData.end_time)}
                  ...
                  {isButtonLoading ? (
                    ...
                    >
                      Claim ({userContribution / 10 ** InfoIdo.suiDecimals} SUI)
                    </Button>
                  )}
                </div>
              </>
